...
func (_u *UserUpdate) SetPremium(v bool) *UserUpdate {
	_u.mutation.SetPremium(v)
	return _u
}

// SetNillablePremium sets the "premium" field if the given value is not nil.
func (_u *UserUpdate) SetNillablePremium(v *bool) *UserUpdate {
	if v != nil {
		_u.SetPremium(*v)
	}
	return _u
...
func (_u *UserUpdate) AddSubscription(v ...*Subscription) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) RemoveSubscription(v ...*Subscription) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// SetPremium sets the "premium" field.
func (_u *UserUpdateOne) SetPremium(v bool) *UserUpdateOne {
	_u.mutation.SetPremium(v)
	return _u
}

// SetNillablePremium sets the "premium" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillablePremium(v *bool) *UserUpdateOne {
	if v != nil {
		_u.SetPremium(*v)
	}
	return _u
...
// AddSubscription adds the "subscription" edges to the Subscription entity.
func (_u *UserUpdateOne) AddSubscription(v ...*Subscription) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveSubscription removes "subscription" edges to Subscription entities.
func (_u *UserUpdateOne) RemoveSubscription(v ...*Subscription) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
